...
void InitTopology() {
  topology = InitializeTopology(TOPOLOGY_GRAPH, 32);

  AddTopologyLink(topology, 0, 29, 1);
  static int window0to29 = 60;
  SetTopologyLinkData(topology, 0, 29, (void *)&window0to29);
  AddTopologyLink(topology, 29, 28, 1);
  SetTopologyLinkData(topology, 29, 28, (void *)"Airport_fee != 0.0");
  AddTopologyLink(topology, 28, 30, 1);
  SetTopologyLinkData(topology, 28, 30, (void *)"Airport_fee");
  AddTopologyLink(topology, 30, 31, 1);
  SetTopologyLinkData(topology, 30, 31, (void *)"Query.csv");
}
    ...
    case 30:
      ...
      case 31:
        ...
        case LP_INIT:
          ...
          output_data->filename = (char *)GetTopologyLinkData(topology, 30, 31);
