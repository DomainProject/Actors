...
public class GrammarCellsSubstituteMenu_ActorScriptGPU extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorScriptGPU() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorScriptGPU", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_yd89fo_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_yd89fo_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorScriptGPU$rx;
    }
  }
