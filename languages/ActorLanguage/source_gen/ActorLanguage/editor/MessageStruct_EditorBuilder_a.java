...
/*package*/ class MessageStruct_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MessageStruct_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d97zuw_a0");
    if (nodeCondition_d97zuw_a0a0()) {
      editorCell.addEditorCell(createCustomFactory_1());
    }
    editorCell.addEditorCell(createCustomFactory_7());
    if (nodeCondition_d97zuw_a2a0()) {
  ...
  private boolean nodeCondition_d97zuw_a0a0() {
  ...
  private boolean nodeCondition_d97zuw_a2a0() {
  ...
  private EditorCell createAlternation_0() {
    ...
    alternationCondition = nodeCondition_d97zuw_a0a0a0();
  ...
  private boolean nodeCondition_d97zuw_a0a0a0() {
  ...
  private EditorCell createSideTransformationSectionCell_0() {
    ...
    editorCell.setCellId("SideTransformationSectionCell_d97zuw_a0a0a0");
    return editorCell;
  }
      ...
      if (isApplicable) {
        GrammarCellsSideTransformTransformationMenuItem item = new GrammarCellsSideTransformTransformationMenuItem(ctx) {
          ...
          public SNode doSubstitute(String pattern) {
            SNode node = SNodeOperations.cast(ctx.getNode(), CONCEPTS.MessageStruct$Me);
            IFlagModelAccess access = new DefaultFlagModelAccess(PROPS.exported$V4am);
  ...
  private EditorCell createCollection_1() {
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = new jetbrains.mps.nodeEditor.cells.EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_d97zuw_a2a0");
    editorCell.addEditorCell(createRefNodeList_0());
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new prefixesListHandler_d97zuw_a0c0a(myNode, getEditorContext());
  ...
  private static class prefixesListHandler_d97zuw_a0c0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public prefixesListHandler_d97zuw_a0c0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(prefixesListHandler_d97zuw_a0c0a.this.getNode(), LINKS.prefixes$hyki));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_d97zuw_e0a");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new membersListHandler_d97zuw_f0a(myNode, getEditorContext());
    jetbrains.mps.nodeEditor.cells.EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class membersListHandler_d97zuw_f0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public membersListHandler_d97zuw_f0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(membersListHandler_d97zuw_f0a.this.getNode(), LINKS.members$C59R));
      try {
        EditorCell emptyCell = null;
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_d97zuw_g0a");
    Style style = new StyleImpl();
    new BracesStyleClass(this).apply(style, editorCell);
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ";");
    editorCell.setCellId("Constant_d97zuw_h0a");
    Style style = new StyleImpl();
