...
public class GrammarCellsSubstituteMenu_IMessageCreation extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IMessageCreation() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IMessageCreation", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_45fcn0_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_45fcn0_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.IMessageCreation$ll;
    }
  }
