...
public class GrammarCellsSubstituteMenu_ActorScriptCPU extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorScriptCPU() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorScriptCPU", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_yd87ya_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_yd87ya_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorScriptCPU$mu;
    }
  }
