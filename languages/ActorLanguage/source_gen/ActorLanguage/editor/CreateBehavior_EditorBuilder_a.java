...
/*package*/ class CreateBehavior_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new statementsListHandler_6o6lrj_h0(myNode, getEditorContext());
  ...
  private static class statementsListHandler_6o6lrj_h0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public statementsListHandler_6o6lrj_h0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statementsListHandler_6o6lrj_h0.this.getNode(), LINKS.statements$MLkf));
      try {
