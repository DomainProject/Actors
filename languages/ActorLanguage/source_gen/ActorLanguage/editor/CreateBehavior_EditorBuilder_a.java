...
/*package*/ class CreateBehavior_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_3() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "{");
    editorCell.setCellId("Constant_6o6lrj_e0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actionsListHandler_6o6lrj_f0(myNode, getEditorContext());
  ...
  private static class actionsListHandler_6o6lrj_f0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actionsListHandler_6o6lrj_f0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actionsListHandler_6o6lrj_f0.this.getNode(), LINKS.actions$MLkf));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new becomeSingleRoleHandler_6o6lrj_h0(myNode, LINKS.become$KDXz, getEditorContext());
    return provider.createCell();
  }
  private static class becomeSingleRoleHandler_6o6lrj_h0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public becomeSingleRoleHandler_6o6lrj_h0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
