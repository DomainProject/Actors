...
public class GrammarCellsSubstituteMenu_NullPayload extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_NullPayload() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "NullPayload", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_197v05_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_197v05_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.NullPayload$JN;
    }
  }
