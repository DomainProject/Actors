...
/*package*/ class Actor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new actionsListHandler_vfz2qj_h0(myNode, getEditorContext());
  ...
  private static class actionsListHandler_vfz2qj_h0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public actionsListHandler_vfz2qj_h0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actionsListHandler_vfz2qj_h0.this.getNode(), LINKS.actions$7fVV));
      try {
