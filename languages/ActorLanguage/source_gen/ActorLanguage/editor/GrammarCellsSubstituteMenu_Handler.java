...
public class GrammarCellsSubstituteMenu_Handler extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Handler() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Handler", null));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new GrammarCellsSubstituteMenuPart_kfuc7_a());
    return result;
  }

  private class GrammarCellsSubstituteMenuPart_kfuc7_a extends GrammarCellsSubstituteMenuPart {
    @Override
