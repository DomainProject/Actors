...
public final class ActorScriptGPU__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x10eda99958984cdeL, 0x9416196c5eca1268L, 0x52e1a8e2e48dc1a4L, "ActorLanguage.structure.ActorScriptGPU");
  ...
  /*package*/ static Iterable<SNode> allReferenceableContentsInChunk_id6clJcrKmVSn(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SLinkOperations.collect(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.types$l07d), CONCEPTS.ExternalType$Bi), LINKS.structDeclaration$Nldq)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.types$l07d), CONCEPTS.CustomType$VF)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.types$l07d), CONCEPTS.ExternalTypeDefinition$1k)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SLinkOperations.collect(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.types$l07d), CONCEPTS.OpaqueTypeDeclaration$jq), LINKS.opaqueType$mnjr)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.externalFunctions$kZSc), CONCEPTS.ExternalFunction$kh)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SLinkOperations.collect(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.externalFunctions$kZSc), CONCEPTS.ExternalFunctionPrototype$n3), LINKS.prototype$75Zb)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.configuration$kYH7), CONCEPTS.GlobalVarDecl$3_)));
    ListSequence.fromList(added).addSequence(Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(__thisNode__, LINKS.configuration$kYH7), CONCEPTS.GlobalConstant$pG)));
    ListSequence.fromList(added).addElement(SLinkOperations.getTarget(__thisNode__, LINKS.messageDefinition$7uZf));
    ListSequence.fromList(base).addSequence(ListSequence.fromList(added));
    return base;
  }

  /*package*/ ActorScriptGPU__BehaviorDescriptor() {
  }
