...
public class ChangeFetchPolicy_Constraints extends BaseConstraintsDescriptor {
  /*package*/ ChangeFetchPolicy_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.ChangeFetchPolicy$Nx, initContext);
    record(new NewPolicy_PD(this));
  }

  /*package*/ static final class NewPolicy_PD extends BasePropertyConstraintsDescriptor {
    public NewPolicy_PD(ConstraintsDescriptor container) {
