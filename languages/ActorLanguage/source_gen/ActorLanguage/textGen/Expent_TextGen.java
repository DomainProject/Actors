...
public class Expent_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    if ((SNodeOperations.getNodeAncestor(ctx.getPrimaryInput(), CONCEPTS.ActorScriptCPU$mu, false, false) != null)) {
      ...
      tgs.append("->ctx, ");
      tgs.appendNode(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.mean$Gp5E));
      tgs.append(")");
    } else {
      // GPU
      tgs.append("random_exp(cr_state, ");
      tgs.appendNode(SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.mean$Gp5E));
      tgs.append(")");
    }
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink mean$Gp5E = MetaAdapterFactory.getContainmentLink(0x10eda99958984cdeL, 0x9416196c5eca1268L, 0x1a7ee5b87dbcb092L, 0x1a7ee5b87dbcb093L, "mean");
  }
}
