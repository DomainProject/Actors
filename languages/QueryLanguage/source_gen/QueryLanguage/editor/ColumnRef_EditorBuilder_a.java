...
/*package*/ class ColumnRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_s4t3l3_a0a()) {
      editorCell.addEditorCell(createRefNode_0());
    }
    if (nodeCondition_s4t3l3_a1a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    if (nodeCondition_s4t3l3_a2a()) {
      editorCell.addEditorCell(createRefCell_0());
    }
    if (nodeCondition_s4t3l3_a3a()) {
      editorCell.addEditorCell(createRefCell_1());
    }
    if (nodeCondition_s4t3l3_a4a()) {
  ...
  private boolean nodeCondition_s4t3l3_a2a() {
    ...
    return ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(myNode, CONCEPTS.Select$Te, false, false), LINKS.tables$IXdn)).count() <= 1;
  }
  private boolean nodeCondition_s4t3l3_a3a() {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.column$Wyeu;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.column$Wyeu);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.column$Wyeu);
    }
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.column$Wyeu);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_notnull_smartReference(cell);
        return cell;
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_1() {
      getCellFactory().pushCellContext();
      try {
        final SProperty property = PROPS.fullName$t1KL;
        getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
        EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, true, false), myNode);
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
    editorCell.setCellId("Constant_s4t3l3_e0");
    Style style = new StyleImpl();
