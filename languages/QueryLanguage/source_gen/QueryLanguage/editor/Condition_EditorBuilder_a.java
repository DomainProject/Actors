...
/*package*/ class Condition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.column$rrbV;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.column$rrbV);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.column$rrbV);
    }
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.conditionOperator$25uv;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty conditionOperator$25uv = MetaAdapterFactory.getProperty(0x26d1395b1ee643adL, 0xb522c0cdd699ded3L, 0x11100ee737470ff3L, 0x23d860ebbb7c269fL, "conditionOperator");
  }
}
