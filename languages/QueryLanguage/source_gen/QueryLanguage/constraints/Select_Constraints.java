...
public class Select_Constraints extends BaseConstraintsDescriptor {
  /*package*/ Select_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.Select$Te, initContext);
    record(new ViewName_PD(this));
  }

  /*package*/ static final class ViewName_PD extends BasePropertyConstraintsDescriptor {
    public ViewName_PD(ConstraintsDescriptor container) {
