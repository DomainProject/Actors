...
public class TableReference_Constraints extends BaseConstraintsDescriptor {
  /*package*/ TableReference_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.TableReference$DN, initContext);
    record(new RD1(this));
  }

  /*package*/ static final class RD1 extends BaseReferenceConstraintsDescriptor {
    /*package*/ RD1(ConstraintsDescriptor container) {
      super(LINKS.tableRef$boeY, container, true, false);
    }
    @Nullable
    @Override
